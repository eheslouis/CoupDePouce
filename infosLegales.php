...
<html lang="en">
    <head>
        ...
        <link href="css/infosLegales.css" rel="stylesheet">
    </head>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-9 col-md-push-3">
                    ...
                    <div class="contenu">
                        Coup de Pouce Vietnam est reconnue sous le numero : 166/CNV-HD <br>Le PACCOM (People's Aid Coordinating Committee) est un organisme gouvernemental vietnamien qui gère les ONG et qui est rattaché au Ministère des Affaires Etrangères.<br>
                    </div>
                    <h3>
                        Rapports Annuels
                    </h3>
